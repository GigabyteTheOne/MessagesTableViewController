...
- (void)viewDidLoad
{
    ...
    self.messages = [[NSMutableArray alloc] initWithObjects:
                     ...
                     [[JSMessage alloc] initWithText:@"Group chat. Sound effects and images included. Animations are smooth. Messages can be of arbitrary size! Group chat. Sound effects and images included. Animations are smooth. Messages can be of arbitrary size!" sender:kSubtitleWoz date:[NSDate date]],
                     [[JSMessage alloc] initWithText:@"Look, messages with images!" image:[UIImage imageNamed:@"kitty.jpg"]
                                              sender:kSubtitleCook date:[NSDate date]],
                     nil];
